...
public class InfectedLlamaEntityRenderer extends MobEntityRenderer<InfectedLlamaEntity, InfectedLlamaEntityModel> {
    private static final Identifier CREAMY_TEXTURE = Identifier.of(HerobrineMod.MODID, "textures/entity/infected_llama/creamy.png");
    private static final Identifier WHITE_TEXTURE = Identifier.of(HerobrineMod.MODID, "textures/entity/infected_llama/white.png");
    private static final Identifier BROWN_TEXTURE = Identifier.of(HerobrineMod.MODID, "textures/entity/infected_llama/brown.png");
    private static final Identifier GRAY_TEXTURE = Identifier.of(HerobrineMod.MODID, "textures/entity/infected_llama/gray.png");
